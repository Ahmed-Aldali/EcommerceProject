...
@section('main_title' , 'Create Seller')

@section('sub_title' , 'Create Seller')
            ...
            <form>
              ...
              <div class="card-body">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="first_name" id="first_name" placeholder="Enter Name of Seller">
                </div>
                <div class="form-group col-md-6">
                    <label for="last_name">Last Name of Seller</label>
                  <input type="text" class="form-control" name="last_name" id="last_name" placeholder="Enter Name of Seller">
                </div>
                </div>
                ...
                <div class="row">
                    ...
                    <input type="email" class="form-control" name="email" id="email" placeholder="Enter Name of Seller">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                    ...
                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Enter Name of Seller">
                  </div>
                  <div class="form-group col-md-6">
                      <label for="address"> Address of Seller</label>
                    <input type="text" class="form-control" name="address" id="address" placeholder="Enter Name of Seller">
                  </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <input type="date" class="form-control" name="date" id="date" placeholder="Enter Name of Seller">
                  </div>
                  <div class="form-group col-md-6">
